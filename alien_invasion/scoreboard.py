...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        # prepare the initial score images, level, and ship images
        self.prep_score()
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render('Current Score: ' + score_str, True,
    ...
    def show_score(self):
        """Draw the scores, level and remaining ships on the screen"""
